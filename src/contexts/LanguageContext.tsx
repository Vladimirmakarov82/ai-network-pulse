...
const translations = {
  ...
  ru: {
    ...
    'faq.a1': 'Возможность приходить на любые встречи Pulse в любом городе в течение 1 года.\nНа первой встрече ты расскажешь, чем можешь быть полезен и что ищешь. С этого момента PULSE AI начинает работать на тебя: он анализирует контексты встреч и подбирает такие знакомства, которые могут поменять твою жизнь: находит клиентов, сотрудников, партнёров, инвесторов и даже любовников. Чем чаще посещаешь оффлайн встречи, тем больше AI знает о тебе, тем лучше делает подбор онлайн знакомств.',

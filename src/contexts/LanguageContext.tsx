...
const translations = {
  ...
  ru: {
    ...
    'hero.launch.date': 'Запуск: август 2025',
    ...
    'pulseai.feature1.title': '3-5 мэтчей ежедневно',
    ...
    'pulseai.example.title': 'Пример ежедневного мэтча',
    ...
    'pricing.pulse.features.2': '2 целевых ИИ-рекомендации каждую неделю',
    'pricing.pulse.features.3': 'Доступ к глобальному сообществу',
    'pricing.pulse.features.4': 'Telegram канал клуба',
    'pricing.builder.title': 'Builder Pass',
    ...
    'pricing.builder.features.2': '2 целевых ИИ-рекомендации каждую неделю',
    'pricing.builder.features.3': 'Витрина экспертов',
    'pricing.builder.features.4': 'Возможности выступлений',
    'pricing.org.title': 'Org Pass',
    ...
    'faq.a1': '1. Еженедельно Pulse AI будет находить тебе по 2 наиболее ценных знакомства среди участников, согласно твоим запросам: ищешь клиентов, инвесторов, партнера для отношений? Просто укажи это в интро…\n\n2. Возможность приходить на любые встречи Pulse в любом городе в течение 1 года.\nЧем чаще посещаешь оффлайн встречи, тем больше AI знает о тебе, тем лучше делает подбор онлайн знакомств. (следите за запусками оффлайн встреч в вашем городе)',
    'faq.q2': 'У меня нет сильного личного бренда — мне точно сюда?',
    'faq.a2': 'Pulse Community помогает раскрыть возможности каждого. Часто ты сам не понимаешь, какую ценность можешь оказать другим. Pulse AI позволяет раскрывать эти ценности и растить свой бренд внутри комьюнити на автомате.',
    ...
    'faq.a4': 'Если у тебя достаточно развит социальный капитал, если на любое мероприятие, которое ты организовываешь, к тебе легко приходят 30+ человек, то можешь оставить заявку, нажав кнопку «стать организатором». Владелец ORG PASS является партнером Pulse Community и зарабатывает на организации регулярных встреч 25-100 тыс/мес, за 3-4 часа в неделю.',
    ...
    'faq.a6': 'Ты можешь забыть, кого встретил на прошлой неделе, а Pulse AI не забудет. Каждое твоё участие во встречах — это набор сигналов: голос, интересы, цели, запросы. Pulse AI соединяет их с сотнями других участников по всему миру и предлагает тебе наиболее точные совпадения, помогая найти клиентов, партнёров, друзей, любовников, сотрудников или инвесторов.',
    ...
    'faq.a12': '1. ВОРОНКА\nВстречи Pulse Community часто становятся первой точкой входа для других, более специализированных клубов. Купить годовой Pass Pulse Community, в отличие от многих клубов, может позволить себе даже студент. Но участие означает, что человек понимает ценность нетворкинга и он открыт к новым знакомствам. В Pulse Community можно прийти без чёткого запроса — познакомиться, послушать, почувствовать формат. Такие люди уже прошли серьезный фильтр и вероятно многие из них захотят попасть в более специализированные клубы по интересам.\n\n2. Нетворкинг, усиленный AI для своих участников\nНаверняка участники клуба не раз просили создать базу данных участников, возможно она имеется, но насколько эффективно используется? На 3 или 5 процентов? Мы используем AI, чтобы он помогал участникам продавать, находить партнеров, находить инвесторов и даже знакомить пары.',
